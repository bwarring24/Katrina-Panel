<form name="login" method="POST" >
  ...
  <div id="login">
    ...
    <div class="frmInput"><h2><input id="txtFirstName" type="text" name="firstName" pattern="^[a-zA-Z]+$" placeholder="i.e. John" oninput="check(this)" size="20" required /><span class="error">*</h2></div>
  </div>
  ...
  <div id="login">
    ...
    <div class="frmInput"><h2><input id="txtPass" type="password" name="password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{5,}$" placeholder="i.e. abcdef123" oninput="check(this)" size="20" required/><span class="error">*</span></h2></div>
  </div>
  
  <div id="login">
    <div class="frmLabel"><h2>{lang:register-retypePassword}</h2></div>
    <div class="frmInput"><h2><input id="txtPass" type="password" name="password2" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{5,}$" placeholder="i.e. abcdef123" oninput="check(this)" size="20" required/><span class="error">*</span></h2></div>
  </div>
